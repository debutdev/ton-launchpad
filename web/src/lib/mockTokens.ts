...
export const MOCK_TOKENS: MockToken[] = [
  {
    ...
    jettonAddress: 'EQJ1mockJettonInstantgramInu00000000000001',
    name: 'Instantgram Inu',
    ticker: 'TONK',
...
export const MOCK_DIRECTORY_TOKENS: MockToken[] = [
  ...
  ...EXTRA_NAMES.map(([name, ticker], index) => {
    ...
    return {
      ...
      name,
      ticker,
      description: `${name} is a mock Instantgram launchpad token for browsing and layout testing.`,
